  ...
  return (
    <Shine>
      <section className="pt-24 text-center">
        <span className="text-2xl font-bold tracking-tighter px-24 sm:text-3xl md:text-4xl lg:text-5xl/none text-transparent bg-clip-text bg-gradient-to-b from-orange-500 to-lime-300">
        </span>
      </section>
    </Shine>
  );
